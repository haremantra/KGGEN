...
% Section formatting
\titleformat{\section}
  {\Large\bfseries\color{kdenseblue}}
  {\thesection}{1em}{}
\titleformat{\subsection}
  {\large\bfseries\color{kdensegray}}
  {\thesubsection}{1em}{}

% Header and footer
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small CUAD Knowledge Graph Generator PRD}
\fancyhead[R]{\small v1.0 | 2026-01-12}
\fancyfoot[C]{\thepage}
...
\textbf{LLM Prompt:}
\begin{lstlisting}[language=Python, caption=Entity Extraction Prompt Template]
...
\textbf{LLM Prompt:}
\begin{lstlisting}[language=Python, caption=Relation Extraction Prompt Template]
...
\begin{lstlisting}[language=JSON, caption=Sample Extraction Output]
{
...
\textbf{LLM Prompt:}
\begin{lstlisting}[language=Python, caption=Entity Deduplication Prompt]
...
\textbf{LLM Prompt:}
\begin{lstlisting}[language=Python, caption=Canonicalization Prompt]
...
\begin{lstlisting}[caption=LLM Context Template]
